...
<div class="details-course">
    ...
    <div class="container">
        ...
        <div class="col-md-5 text-center">
            @if( $user->image != '' )
            <img src="{{url("uploads/users/".$user->image)}}" alt="{{$user->name}}" class="img-student-detail img-circle">
            @else
            <img src="{{url('assets/imgs/profile.png')}}" alt="{{$user->name}}" class="img-student-detail img-circle">
            @endif
        </div>
    </div>
</div>
